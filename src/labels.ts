import type { DiffType, MergedSubject, Module, ModuleTimeTable, Terms, TimeTable } from "./types.js";

export const typeLabels: Record<DiffType, string> = {
    added: "追加",
    modified: "変更",
    removed: "削除",
};

export const fieldLabels: Record<keyof MergedSubject, string> = {
    code: "科目番号",
    name: "科目名",
...
export const isDiffSubjectKey = (key: string): key is keyof MergedSubject => key in valueFormatters;

export const formatValue = <K extends keyof MergedSubject>(key: K, value: MergedSubject[K]): string => valueFormatters[key](value);
